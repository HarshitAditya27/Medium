            ...
            <form
                ...
                <label className='block mb-5'>
                    ...
                    <input
                        ...
                        className='shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring' placeholder="Harshit Aditya" type='text' />
                </label>
                <label className='block mb-5'>
                    <span className='text-gray-700'>Email</span>
                    <input  {...register('email', { required: true })} className='shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring' placeholder="Harshit Aditya" type='email' />
                </label>
                <label className='block mb-5'>
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    ...
    *[_type == "post" && slug.current == $slug][0]{ 
    ...
    return {
        ...
        revalidate: 60, // after 60 seconds, old catche gets updated
    }
}
